...
class Obstacle(pygame.sprite.Sprite):
	def __init__(self,type):
		...
		if type == 'fly':
			...
			blob_1 = pygame.image.load('images/blob1.png').convert_alpha()
			blob_2 = pygame.image.load('images/blob2.png').convert_alpha()
...
# Intro screen
player_stand = pygame.image.load('images/jump.png').convert_alpha()
	...
	for event in pygame.event.get():
		...
		if game_active:
			if event.type == obstacle_timer:
				obstacle_group.add(Obstacle(choice(['fly','blob','blob','blob'])))
